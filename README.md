...
The [Config/Tutorial](https://github.com/project8/locust_mc/tree/master/Config/Tutorial) directory contains an example guiding the user through the full simulation of electrons in Phases I-IV. The processing of egg files generated by locust is done using [Katydid](https://github.com/project8/katydid) (recommended), and is covered in the tutorial as well.
