...
namespace locust
{
LMCMPIInterface* LMCMPIInterface::fMPIInterface = nullptr;

LMCMPIInterface::LMCMPIInterface()
{
    fProcess = -1;
    fNProcesses = -1;
    fLocalRank = -1;
...
void LMCMPIInterface::SetSplitMode(bool enable)
{
    fSplitMode = enable;
...
void LMCMPIInterface::Initialize(int* argc, char*** argv, bool split_mode)
{
...
/**
   * Interface to accessing LMCMPIInterface.
   */
LMCMPIInterface* LMCMPIInterface::GetInstance()
{
    if (fMPIInterface == nullptr)
        fMPIInterface = new LMCMPIInterface();
...
/**
   ...
   */
void LMCMPIInterface::BeginSequentialProcess()
{
    int flag = 1;
...
/**
   ...
   */
void LMCMPIInterface::EndSequentialProcess()
{
    int flag = 0;
...
void LMCMPIInterface::PrintMessage(std::string msg)
{
...
void LMCMPIInterface::DetermineLocalRank()
{
#ifdef LOCAL_RANK_MPI
    ...
    if (ret_val != 0) {
        ...
        LMCMPIInterface::GetInstance()->Finalize();
        std::exit(1);
    };
...
void LMCMPIInterface::SetupSubGroups()
{
#ifdef LOCAL_RANK_MPI
