#ifndef LMCMPIINTERFACE_DEF
#define LMCMPIINTERFACE_DEF
...
class LMCMPIInterface
{
  public:
    static LMCMPIInterface* GetInstance();
  ...
  protected:
    LMCMPIInterface();
    virtual ~LMCMPIInterface();

    static LMCMPIInterface* fMPIInterface;
