...
namespace locust
{
    ...
    public:
        ...
        virtual std::pair<double,double> ConvolveWithComplexFIRFilterArray_norm(int bTE, int l, int m, int n, std::deque<double> inputBuffer, double t);
    ...
    public:
        ...
        bool ConvertAnalyticGFtoFIR( std::vector<std::vector<int>> aModeSet, std::vector<std::vector<std::pair<double,std::pair<double,double>>>> gfArray);
