...
namespace locust
{
    ...
    std::pair<double,double> HFSSResponseFileHandlerCore::ConvolveWithComplexFIRFilterArray_norm(int bTE, int l, int m, int n, std::deque<double> inputBuffer, double t)
    {
