...
//    					tExcitationAmplitude = sqrt(tKassParticleXP[8]/2.);  // sqrt( Larmor power / 2 )
...
//    						double totalScalingFactor = sqrt(50.) * dotProductFactor;
//    						double totalScalingFactor = sqrt(50.);
