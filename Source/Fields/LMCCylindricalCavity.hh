 ...
 */
    ...
    class CylindricalCavity : public Field
    {
        ...
        public:
            ...
            std::vector<double> TE_E(int l, int m, int n, double r, double theta, double z, double fcyc, bool avgOverTheta) const;
            std::vector<double> TE_H(int l, int m, int n, double r, double theta, double z, double fcyc, bool avgOverTheta) const;
            std::vector<double> TM_E(int l, int m, int n, double r, double theta, double z, double fcyc, bool avgOverTheta) const;
            std::vector<double> TM_H(int l, int m, int n, double r, double theta, double z, double fcyc, bool avgOverTheta) const;
