...
this_version = 'v?.?.?'
try:
    this_version = check_output(['git', 'describe', '--abbrev=0', '--tags']).decode('utf-8')
except:
    pass
...
project = u'Locust'
copyright = u'2018, Locust Authors'
...
latex_documents = [
  (master_doc, 'Locust.tex', u'Locust Documentation',
...
man_pages = [
    (master_doc, 'locust', u'Locust Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Locust', 'Locust Documentation',
   author, 'Locust', 'Data processing framework',
   'Miscellaneous'),
]
